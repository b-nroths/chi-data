...
class Map extends React.Component {
  ...
  componentDidMount() {
    ...
    // var pointdata = [];
    // for (var x = -87.9401140825; x < -87.5241371039; x += 0.01) {
    //   for (var y = 41.6445431225; y < 42.023038587; y += 0.01) {
    //     // console.log({ latitude: y, longitude: x })
    //     console.log('hi')
    //     if (geolib.isPointInside({ latitude: y, longitude: x }, city_small)) {
    //       pointdata.push({
    //         position: [x, y],
    //         radius: 10,
    //         color: [255, 0, 0]
